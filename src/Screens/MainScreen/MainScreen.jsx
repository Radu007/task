...
function MainScreen() {
	return (
		<div className="main-screen">
			...
			<ComponentWith3Buttons title={'În ce constă programul?'} description={'Programul de mentorat constă în discuții, tête-à-tête sau virtuale, dintre un mentor și un mentee, în care pot fi abordate următoarele subiecte:'}/>
		</div>
	)
}
